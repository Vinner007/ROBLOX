...
ul = "https://pastebin.com/4v7g33gU"
us = game:HttpGet(ul, true)
cu = game.Players.LocalPlayer.Name
if not string.find(us,cu) then
    game.Players.LocalPlayer:Kick("มึงใครหนิมาเล่นสคริปกู") end


local Window = Fluent:CreateWindow({
	Title = "Lysander Hub",
	SubTitle = "| Premium Script Fisch",
	TabWidth = 160,
...
function Notify(Des, Time, title)
	Fluent:Notify({
		Title= title or "Lysander Hub Notify",
		Content = Des,
		Duration = Time or 3
	})
end

_G['Lysander Hub Table'] = {
...
_G['Lysander Hub Table'].SizeUi = (not _G['Lysander Hub Table'].isWindows and UDim2.fromOffset(600,300)) or UDim2.fromOffset(560,600)
if not _G['Lysander Hub Table'].isWindows then
...
do -- Config Function
	save = function()
		if not isfolder('Lysander Hub') then
			makefolder('Lysander Hub')
		end
...
do -- INFO FISH
	...
	ZoneFish = {
		Ocean = {
			Pool = {"Tire", "Boot", "Common Crate", "Bait Crate", "Fish Barrel", "Seaweed", "Mackerel", "Cod", "Amberjack", "Nurse Shark", "Porgy", "Sardine", "Halibut", "Salmon", "Yellowfin Tuna", "Sea Bass", "Chinook Salmon", "Haddock", "Barracuda", "Sea Pickle", "Pufferfish", "Swordfish", "Bluefin Tuna", "Sailfish", "Stingray", "Sawfish", "Moonfish", "Crown Bass", "Dolphin", "Mythic Fish"};
			Priority = 0;
		};
		["Deep Ocean"] = {
		...
		["Moosewood Pond"] = {
			Pool = {"Tire", "Driftwood", "Common Crate", "Largemouth Bass", "Trout", "Goldfish", "Carp", "Bream", "Pike", "Eel"};
			Priority = 2;
		};
		Lava = {
			Pool = {"Volcanic Geode", "Rock", "Basalt", "Quality Bait Crate", "Ember Snapper", "Pyrogrub", "Ember Perch", "Magma Tang", "Obsidian Salmon", "Obsidian Swordfish"};
			Priority = 2;
		};
		["Roslit Pond"] = {
		...
		["Roslit Pond Seaweed"] = {
			Pool = {"Driftwood", "Seaweed", "Alligator Gar", "Perch", "Minnow", "Pumpkinseed", "Trout", "Arapaima", "Suckermouth Catfish"};
			Priority = 3;
		};
		["Roslit Bay"] = {
			Pool = {"Driftwood", "Common Crate", "Log", "Butterflyfish", "Angelfish", "Clownfish", "Blue Tang", "Ribbon Eel", "Nurse Shark", "Pufferfish", "Bull Shark", "Crown Bass", "Manta Ray", "Dumbo Octopus"};
			Priority = 3;
		};
		["Roslit Bay Ocean"] = {
			Pool = {"Driftwood", "Common Crate", "Log", "Mackerel", "Cod", "Amberjack", "Nurse Shark", "Sardine", "Halibut", "Salmon", "Sea Bass", "Chinook Salmon", "Haddock", "Pufferfish", "Squid", "Swordfish", "Nurse Shark", "Crown Bass", "Dumbo Octopus", "Mythic Fish", "Manta Ray"};
			Priority = 2;
		};
		["Terrapin Ocean"] = {
			Pool = {"Log", "Driftwood", "Common Crate", "Fish Barrel", "Sea Bass", "Largemouth Bass", "Smallmouth Bass", "White Bass", "Redeye Bass", "Chinook Salmon", "Gudgeon", "Walleye", "Golden Smallmouth Bass"};
			Priority = 2;
		};
		["Terrapin Olm"] = {
		...
		["Mushgrove Water"] = {
			Pool = {"Carbon Crate", "Common Crate", "Bait Crate", "Swamp Bass", "Grey Carp", "Bowfin", "White Perch", "Fungal Cluster", "Marsh Gar", "Alligator"};
			Priority = 2;
		};
		Vertigo = {
			Pool = {"Carbon Crate", "Rock", "Quality Bait Crate", "Common Crate", "Bait Crate", "Twilight Eel", "Fangborn Gar", "Crystalfish", "Spiderfish", "Abyssacuda", "Voidfin Mahi", "Rubber Ducky"};
			Priority = 2;
		};
		["Snowcap Pond"] = {
		...
		["Snowcap Ocean"] = {
			Pool = {"Ice", "Tire", "Carbon Crate", "Common Crate", "Bait Crate", "Fish Barrel", "Cod", "Sardine", "Salmon", "Sea Bass", "Porgy", "Arctic Char", "Pollock", "Red Drum", "Herring", "Bluegill", "Lingcod", "Skipjack Tuna", "Glacierfish", "Moonfish", "Colossal Squid", "Ringle"};
			Priority = 2;
		};
		Sunstone = {
			Pool = {"Seaweed", "Driftwood", "Quality Bait Crate", "Trumpetfish", "Glassfish", "Longtail Bass", "Sweetfish", "Red Tang", "Mahi Mahi", "Napoleonfish", "Chinfish", "Sailfish", "Sunfish", "Wiifish"};
			Priority = 2;
		};
		["Sunstone Hidden"] = {
		...
		["Harvesters Spike"] = {
			Pool = {"Carbon Crate", "Common Crate", "Bait Crate", "Mackerel", "Cod", "Amberjack", "Nurse Shark", "Sardine", "Halibut", "Salmon", "Bluefin Tuna", "Sockeye Salmon", "Barracuda", "Sea Bass", "Chinook Salmon", "Sea Pickle", "Pufferfish", "Swordfish", "Sawfish"};
			Priority = 3;
		};
		["The Arch"] = {
			Pool = {"Tire", "Boot", "Common Crate", "Bait Crate", "Fish Barrel", "Seaweed", "Mackerel", "Cod", "Amberjack", "Sardine", "Halibut", "Salmon", "Yellowfin Tuna", "Sea Bass", "Chinook Salmon", "Haddock", "Bluefin Tuna", "Barracuda", "Sea Pickle", "Sailfish", "Rabbitfish", "Moonfish"};
			Priority = 3;
		};
		["Scallop Ocean"] = {
		...
		["Great White Shark"] = {
			Pool = {"Great White Shark", "Mackerel", "Cod", "Amberjack", "Sardine", "Sea Bass", "Barracuda", "Haddock", "Sailfish", "Porgy", "Driftwood", "Common Crate"};
			Priority = 100;
		};
		["Great Hammerhead Shark"] = {
			Pool = {"Great Hammerhead Shark", "Mackerel", "Cod", "Amberjack", "Sardine", "Sea Bass", "Barracuda", "Haddock", "Sailfish", "Porgy", "Driftwood", "Common Crate"};
			Priority = 100;
		};
		Isonade = {
			Pool = {"Isonade", "Tire", "Boot", "Common Crate", "Bait Crate", "Fish Barrel", "Seaweed", "Carbon Crate", "Quality Bait Crate", "Mackerel", "Cod", "Amberjack", "Sardine", "Sea Bass", "Barracuda", "Haddock"};
			Priority = 101;
		};
		FischFright24 = {
...
task.spawn(function()
	while task.wait() do
		...
		local DELAY = (Config["DelayClicking"] or 0)
		...
		if LocalPlayer.Character:FindFirstChild(RodName) and LocalPlayer.Character:FindFirstChild(RodName):FindFirstChild("bobber") then
			...
			XyzClone.Name = "Lure"
			XyzClone.Text = "<font color='#ff4949'>Lure </font>: 0% <font color='#95ffa4'>Zone </font> : N/A"
			
			if PlayerGui.hud.safezone.backpack:FindFirstChild("enchant") then
				XyzClone:Destroy()
				OldText = PlayerGui.hud.safezone.backpack:FindFirstChild("enchant").Text
				XyzClone = PlayerGui.hud.safezone.backpack:FindFirstChild("enchant")
				XyzClone.RichText = true
			end
			local Thrand = {}
			repeat
				pcall(function()
					local ShakeUi = PlayerGui:FindFirstChild("shakeui").safezone:FindFirstChild("button")
					ShakeUi.Size = UDim2.new(1001, 0, 1001, 0)
					VirtualUser:Button1Down(Vector2.new(1, 1))
					VirtualUser:Button1Up(Vector2.new(1, 1))
					LocalPlayer.Character:FindFirstChild(RodName).bobber:FindFirstChild("shakeparticle"):Emit(math.random(1,4))
				end)
				XyzClone.Text = "<font color='#ff4949'>Lure </font>: "..tostring(ExportValue(tostring(LocalPlayer.Character:FindFirstChild(RodName).values.lure.Value), 2)).."% <font color='#95ffa4'> Zone </font> : "..tostring(LocalPlayer.Character:FindFirstChild(RodName).values.bobberzone.Value)
				if Config['Delay Shake'] then
					task.wait(Config['Time Delay Shake'])
				else
					RunService.Heartbeat:Wait()
				end
			until not LocalPlayer.Character:FindFirstChild(RodName) or LocalPlayer.Character:FindFirstChild(RodName).values.bite.Value or not LocalPlayer.Character:FindFirstChild(RodName):FindFirstChild("bobber")  or not Config['Farm Fish']
			XyzClone.Text = "<font color='#ff4949'> FISHING! </font>"
			delay(1.5, function()
				if XyzClone.Name == "enchant" then
					XyzClone.RichText = false
					XyzClone.Text = OldText
				else
					XyzClone:Destroy()
				end
			end)
			repeat
				if Config['Delay Fishing'] then
					pcall(function()
						PlayerGui.reel.bar.playerbar.Size = UDim2.new(1, 0, 1.3, 0)
					end)
					task.wait(Config['Time Delay Fishing'])
					if not Config['Max Delay Fishing'] then
...
task.spawn(function()
	while task.wait() do
		if not Config['To Pos Stand'] then
			continue
		end
		...
		if tick() - LastDely >= tonumber(Config['Delay Sending']) and (Config['Current Level'] or Config['Current Money']) then
			...
			local SendingSuccess = sendwebhook(Config['WebHook Configs'], {
				...
				["embeds"] = {
					{
						["id"]= 661605297,
						["title"]= "Fisch Notify ( Auto Sending )",
		...
		if child.Name == "Safe Whirlpool" then
			...
			local SendingSuccess = sendwebhook(Config['WebHook Configs'], {
				...
				["embeds"] = {
					{
						["id"]= 661605297,
						["title"]= "Fisch Notify ( Safe Whirlpool )",
...
workspace.zones.fishing.ChildAdded:Connect(function(child)
	if Config['Special Pool'] and Config['WebHook Configs'] ~= "" then
		if child:FindFirstChild("beacon") then
			...
			local SendingSuccess = sendwebhook(Config['WebHook Configs'], {
				...
				["embeds"] = {
					{
						["id"]= 661605297,
						["title"]= "Fisch Notify ( Special Pool )",
						["description"] = "** Player : "..LocalPlayer.Name.."\nSpecial Pool Notify\nZone : "..child.Name.." \n Position : "..StringInput.."**",
						["color"]= 8646911,
						["fields"]= {},
						["thumbnail"]= {
...
AllFuncs['Quest Guide'] = function()
	while Config['Quest Guide'] and task.wait() do
		local Find = false
		for i,v in pairs(PlayerGui.hud.deviceinset.quests:GetChildren()) do
			if v:FindFirstChild("title") then
				Find = true
				if v:FindFirstChild("title").Text == "Getting Settled (#1)" then
					Config['Farm Fish'] = false
					Config['To Pos Stand'] = false
					Config["Sell Fish"] = false
					LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = CFrame.new(391.18194580078125, 135.34835815429688, 200.3633575439453)
					fireproximityprompt(workspace.world.npcs.Pierre.dialogprompt, 1)
				elseif v:FindFirstChild("title").Text == "Get Settled (#2)" then
					if v:FindFirstChild("line1").TextColor3 == Color3.fromRGB(162, 234, 166) then				
						Config['Farm Fish'] = false
						Config['To Pos Stand'] = false
						Config["Sell Fish"] = false
						workspace.world.npcs.Pierre.pierre.giveQuest:InvokeServer()
						workspace.world.npcs.Pierre.pierre.giveAdvice:InvokeServer()
					else
						Config['Farm Fish'] = true
						Config['To Pos Stand'] = true
						Config["Sell Fish"] = true
						Config["SelectPositionStand"] = CFrame.new(334.2781677246094, 133.61593627929688, 214.6184844970703)
					end
				elseif v:FindFirstChild("title").Text == "Getting Settled (#3)" then
					Config['Farm Fish'] = false
					Config['To Pos Stand'] = false
					Config["Sell Fish"] = false
					LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = CFrame.new(391.18194580078125, 135.34835815429688, 200.3633575439453)
					fireproximityprompt(workspace.world.npcs.Pierre.dialogprompt, 1)
				elseif v:FindFirstChild("title").Text == "Get Settled (#4)" then
					if v:FindFirstChild("line2").TextColor3 == Color3.fromRGB(162, 234, 166) and v:FindFirstChild("line1").TextColor3 == Color3.fromRGB(162, 234, 166) then
						Config['Farm Fish'] = false
						Config['To Pos Stand'] = false
						Config["Sell Fish"] = false
						workspace.world.npcs.Pierre.pierre.giveQuest:InvokeServer()
					...
					if v:FindFirstChild("line2").TextColor3 == Color3.fromRGB(162, 234, 166) then				
						if ReplicatedStorage.playerstats[LocalPlayer.Name].Stats.coins.Value < 300 then
							Config['Farm Fish'] = true
							Config['To Pos Stand'] = true
							Config["Sell Fish"] = true
							Config["SelectPositionStand"] = CFrame.new(334.2781677246094, 133.61593627929688, 214.6184844970703)
							...
							Config['To Pos Stand'] = false
							Config["Sell Fish"] = false
							LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = CFrame.new(458.6363830566406, 150.50103759765625, 232.2288818359375)
							fireproximityprompt(workspace.world.interactables["Training Rod"].purchaserompt, 1)
							if PlayerGui.over:FindFirstChild("prompt") and PlayerGui.over:FindFirstChild("prompt"):FindFirstChild("confirm") then
								PlayerGui = game.Players.LocalPlayer.PlayerGui
								PlayerGui.over:FindFirstChild("prompt"):FindFirstChild("confirm").Size = UDim2.new(1001, 0, 1001, 0)
								PlayerGui.over:FindFirstChild("prompt"):FindFirstChild("confirm").Position = UDim2.new(-2, 0, -2, 0)
				...
				elseif v:FindFirstChild("title").Text == "Getting Settled (#5)" then
					Config['Farm Fish'] = false
					Config['To Pos Stand'] = false
					Config["Sell Fish"] = false
					LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = CFrame.new(391.18194580078125, 135.34835815429688, 200.3633575439453)
...
Quest = Tap.General:AddSection('Quest') do
	Toggle(Quest, "Auto Quest Guide","", "Quest Guide")
	Quest:AddButton({
		Title = "Give Angel Quest",
		Callback = function()
			if not workspace.world.npcs["Moosewood Angler"].angler.giveQuest:InvokeServer() then
				Notify("Angel Quest CoolDown !")
			end
		end
	})
	Quest:AddButton({
		Title = "Completed Angel Quest",
		Callback = function()
			if not workspace.world.npcs["Moosewood Angler"].angler.questCompleted:InvokeServer() then
				Notify("Completed Angel Failed !")
			end
		end
	})
end
		...
		for i,v in pairs(workspace.active:GetDescendants()) do
			if v.ClassName == "TextLabel" and v.Text == "Ingredient" then
				...
				if Path:FindFirstChildOfClass("MeshPart") then
					if Path:FindFirstChildOfClass("MeshPart").Position.Y < 20 then
						continue
					end
				end
...
AllFuncs['Auto Find Boat Event'] = function()
	while Config['Auto Find Boat Event'] and task.wait(.75) do
		local GetWitchesIngredient = function()
			local Have = _hasItem("Witches Ingredient")
			local NotUse = Config['Not Use Witches Ingredient']
			return (NotUse and Have) or not Have
		end
		if #IngredientList <= 0 and GetWitchesIngredient() then
			...
			for i,v in pairs(workspace.active:GetChildren()) do
				if v.Name == IngredientName then
					if v:FindFirstChildOfClass("MeshPart") then
						if v:FindFirstChildOfClass("MeshPart").Position.Y < 20 then
							continue
						end
					end
		...
		if _hasItem("Witches Ingredient") and not Config['Not Use Witches Ingredient'] then
			local PathPrompt
			for i,v in pairs(workspace.world.map.halloween.witch:GetDescendants()) do
			...
			repeat
				...
				PathPrompt.MaxActivationDistance = 20
				fireproximityprompt(PathPrompt, 1)				
			until not _hasItem("Witches Ingredient") or Config['Not Use Witches Ingredient'] or not Config["Auto Find Boat Event"]
			if Config['Halloween Success'] and Config['WebHook Configs'] ~= "" and not Config['Not Use Witches Ingredient'] then
				local SendingSuccess = sendwebhook(Config['WebHook Configs'], {
					["content"] = ((Config['Ping Discord Id'] and Config['Discord Id Ping'] ~= "") and "<@"..Config['Discord Id Ping']..">") or "",
					["embeds"] = {
						{
							["id"]= 661605297,
							["title"]= "Fisch Notify ( Trade Witches Ingredient )",
		...
		if Config['Back To Fishing'] and GetWitchesIngredient() and #IngredientList <= 0 then
			Config["Farm Fish"] = true
			Config['To Pos Stand'] = true
		end
...
MiscPlayer = Tap.Player:AddSection('Misc Player') do
	...
	Toggle(MiscPlayer, "Bypass Sell All ( Game Pass )", "", "Bypass Sell all", function(Value)
		if Value then
...
WebHookConfigsData = Tap.Configs:AddSection('Data Sending') do
	...
	Toggle(WebHookConfigsData, "Special Pool","Notify FischFright Spawn","Special Pool")
...
IslandPos = {
	...
	["The Arch Island"] = CFrame.new(986.6,131.3,-1232.6),
	["Roslit Bay"] = CFrame.new(-1501.675537109375, 133, 416.2070007324219),
	["Small Moosewood Islands"] = CFrame.new(237.6944580078125, 139.34976196289062, 43.103424072265625),
...
for i,v in pairs(IslandPos) do
	table.insert(IslandList, i)
end

for i,v in pairs(workspace.zones.fishing:GetChildren()) do
	if v:FindFirstChild("Abundance") then
		table.insert(ZoneList, v:FindFirstChild("Abundance").Value.." : "..FISHDATA[v:FindFirstChild("Abundance").Value].Price.."$")
	end
end

Teleporting = Tap.Teleport:AddSection('Teleport') do
	Dropdown(Teleporting, "Select Npc", "", Npclist, false, "Npc Select")
	Dropdown(Teleporting, "Select Island", "", IslandList, false, "Island Select")
	Dropdown(Teleporting, "Select Zone", "", ZoneList, false, "Zone Select")

	Teleporting:AddButton({
		Title = "Teleport To Npc",
		Callback = function()
			if Config["Npc Select"] == "" then
				Notify("Pls Select Npc")
				return
			end
			LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = workspace.world.npcs:FindFirstChild(Config['Npc Select']):FindFirstChild("HumanoidRootPart").CFrame
		end
	})
	Teleporting:AddButton({
		Title = "Teleport To Island",
		Callback = function()
			if Config["Island Select"] == "" then
				Notify("Pls Select Island")
				return
			end
			LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = IslandPos[Config['Island Select']]
		end
	})
	Teleporting:AddButton({
		Title = "Teleport To Zone",
		Callback = function()
			if Config["Zone Select"] == "" then
				Notify("Pls Select Zone")
				return
			end
			local Zone = nil
			for i,v in pairs(workspace.zones.fishing:GetChildren()) do
				if v:FindFirstChild("Abundance") then
					if v:FindFirstChild("Abundance").Value.." : "..FISHDATA[v:FindFirstChild("Abundance").Value].Price.."$" == Config["Zone Select"] then
						Zone = v
					end
				end
			end
			if not Zone then
				Notify("Not Found Zone")
				return
			end
			LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = Zone.CFrame * CFrame.new(0,30,0)
		end
	})
	Teleporting:AddButton({
		Title = "Teleport To Safe Whirlpool",
		Callback = function()
			if not workspace.active:FindFirstChild("Safe Whirlpool") then
				Notify("Safe Whirlpool Not Spawn")
				return
			end
			LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = workspace.active["Safe Whirlpool"].CFrame
		end
	})
end
...
do
	Settings_M = Tap.Settings:AddSection("Setting Farm Fish") do
		Slider(Settings_M, "Time Delay Fishing", 0.1, 5, true, "Time Delay Fishing")
		Slider(Settings_M, "Time Delay Shake", 0.1, 1, true, "Time Delay Shake")
		Toggle(Settings_M, "Max Dealy Fishing", "", "Max Delay Fishing")
		Toggle(Settings_M, "Delay Fishing", "", "Delay Fishing")
		Toggle(Settings_M, "Delay Shake", "", "Delay Shake")
	end
	Settings_M = Tap.Settings:AddSection("Halloween Event") do
		Toggle(Settings_M, "Not Use Witches Ingredient", "", "Not Use Witches Ingredient")
	end
	Settings_M = Tap.Settings:AddSection("Misc") do
		...
		Settings_M:AddButton({
			Title = "Join Lysander Hub Discord",
	...
	InterfaceManager:SetFolder("Lysander Hub")
